...
{
  # Offsite backup #2 (encrypted, independent of the desktop-side pull in
  # modules/user/vaultwarden-backup/backup.nix) so a single machine dying
  # doesn't take out the only copy. Covers state that isn't already
